                                            ...
                                            <form id="addForm" method="POST" action="{{route('products.store')}}" enctype="multipart/form-data" class="form-horizontal">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                            {{-- <label  id="togglebutton" class="switch"> --}}
                                                                    <input class="switch" name="featured" type="checkbox">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-check  form-check-inline col-sm-10">
                                                        <input type="radio" name="old" id="old_new1" value="1" checked>Old<br/>
                                                        <input type="radio" name="old" id="old_new2" value="0">New
