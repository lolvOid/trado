...
@section('pages')
   ...
   <div class="card">
        <div class="card-body">
            <div class="media">
                <div><img class="rounded-circle mr-3" src="assets/img/pyc.jpg" style="height:104px;width:106px;"></div>
                <div class="media-body">
                    <ul class="list-unstyled fa-ul">
                        <li><i class="fa fa-user fa-li" style="font-size:19px;"></i><a href="#" style="font-size:19px;">Pann Yaung Chel</a></li>
                        <li><i class="fa fa-envelope fa-li"></i><a href="#">chellay@gmail.com </a></li>
...
<span class="text-muted"><i class="fa fa-calendar fa-fw"></i> Joined Tradoexchange on 18-8-2018</span></p><div class="panel panel-default">
    <ul class="nav nav-tabs panel-heading">
        <li class="nav-item"><a role="tab" data-toggle="tab" href="#tab-1" class="nav-link">Products Uploaded</a></li>
                ...
                <div class="col-9 col-sm-10 col-md-3 col-lg-3 col-xl-3 offset-sm-0 col-md-4 card">
                    <div class="row">
                        <div class="col-sm-10 col-md-12 col-xl-12 offset-sm-0 col-md-5">
                            <div style="background-color:#ffffff;width:200px;"></div><img src="assets/img/Photoproduct.png" style="height:242px;" /></div>
