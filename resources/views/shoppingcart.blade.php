                    ...
                    <div class="items">
                        <div class="product">
                            <div class="row justify-content-center align-items-center">
                                <div class="col-md-3">
                                    <div class="product-image"><img class="img-fluid d-block mx-auto image" src="img/iPhoneX.jpg" /></div>
                                </div>
                        ...
                        <div class="product">
                            <div class="row justify-content-center align-items-center">
                                <div class="col-md-3">
                                    <div class="product-image"><img class="img-fluid d-block mx-auto image" src="tech/image2.jpg" /></div>
                                </div>
                                <div class="col-md-5 product-info"><a href="#" class="product-name">Lorem Ipsum dolor</a>
                                    <div class="product-specs">
                                        <div><span>Display:</span><span class="value">5 inch</span></div>
