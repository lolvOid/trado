            ...
            <form action="javascript:void(0);" method="get" id="contactForm"><input class="form-control" type="hidden" name="Introduction" value="This email was sent from www.awebsite.com"><input class="form-control" type="hidden" name="subject" value="Awebsite.com Contact Form"><input class="form-control" type="hidden"
                ...
                <div class="form-row">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <div class="form-row">
                            <div class="col-12">
                                <div class="static-map"><a href="https://www.google.com/maps/place/University+of+Information+Technology,+UIT/@16.8230912,96.1202195,13z/data=!4m5!3m4!1s0x30c1eb5a634a7f33:0x4fa272a704e38513!8m2!3d16.8556513!4d96.13536"
    target="_blank" rel="noopener"><img src="assets/img/maps.png" alt="Google Map of University of Information Technology" class="img-fluid" /></a></div>
                            </div>
                            <div class="col-sm-6 col-md-12 col-lg-6">
                                <h2 class="h4"><i class="fa fa-user"></i> Our Info</h2>
                                <div><span><strong>Name</strong></span></div>
                                <div><span>tradoexchange@gmail.com</span></div>
                                <div><span>tradoexchange.com</span></div>
                                <hr class="d-sm-none d-md-block d-lg-none">
                            </div>
                            <div class="col-sm-6 col-md-12 col-lg-6">
                                <h2 class="h4"><i class="fa fa-location-arrow"></i> Our Address</h2>
                                <div><span><strong>Office Name</strong></span></div>
                                <div><span>University of Information technology</span></div>
                                <div><span>Hlaing Township</span></div>
